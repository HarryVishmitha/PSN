...
const AdminDashboard = ({ children, userDetails }) => {
    ...
    const handleSidebarToggle = () => {
        ...
        Cookies.set('sidebarActive', newSidebarState ? 'active' : 'inactive', {
            expires: 365,
        });
    };
                        ...
                        <ul className="sidebar-menu" id="sidebar-menu">
                            ...
                            <li className="dropdown">
                                ...
                                <ul className="sidebar-submenu">
                                    <li>
                                        <Link
                                            href={route(
                                                'admin.inventoryProviders',
                                            )}
                                            className={
                                                url ===
                                                '/admin/manage/inventory/providers'
                                                    ? 'active-page'
                                                    : ''
                                            }
                                        >
                            ...
                            <li className="mb-3">
                                <Link
                                    ...
                                    className={
                                        url === '/admin/templates' ||
                                        url.startsWith('/admin/templates/')
                                            ? 'active-page'
                                            : ''
                                    }
                                >
                            ...
                            <li className="dropdown">
                                <Link href={route('admin.siteSettings')}>
                                    <Icon
                                        ...
                                        className="menu-icon tw-text-red-500"
                                        alt="designs"
                                    />
                                ...
                                <ul className="sidebar-submenu">
                                    <li>
                                        <Link
                                            href={route(
                                                'admin.topnavCategories',
                                            )}
                                            className={
                                                url ===
                                                '/admin/site-settings/topnav-categories/manage'
                                                    ? 'active-page'
                                                    : ''
                                            }
                                        >
                                    ...
                                    <li>
                                        ...
                                        >
                                            <i className="ri-circle-fill circle-icon w-auto tw-text-orange-500" />{' '}
                                            Payment Settings
                                        </Link>
                                    </li>
                                    <li>
                ...
                >
                    ...
                    <footer className="d-footer text-sm">
                        <div className="row align-items-center justify-content-between">
                            <div className="col-auto">
                                <p className="mb-0">
                                    &copy; {currentYear} Printair. All Rights
                                    Reserved.
                                </p>
                            </div>
                            <div className="col-auto">
